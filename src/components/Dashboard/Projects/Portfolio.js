...
const Portfolio = () => {
	...
	return (
		<div className="">{isproject ? <AddProject /> : <ViewProjects />}</div>
	);
};
			...
			<div>
				...
				<form className="p-3 " onSubmit={handleProjectForm}>
					<div className="flex flex-col lg:flex-row items-center gap-5">
						...
						<div className="mb-3 flex flex-col items-start w-full">
							<label for="Client-Name" className="font-bold mb-1">
								Client Name *
							</label>
							<input
								type="text"
					...
					<div className="flex flex-col lg:flex-row items-center gap-5">
						<div className="mb-3 flex flex-col items-start w-full">
							<label for="projectsub" className="font-bold mb-1">
								Select Service *
							</label>
							<div className="flex justify-center w-full">
								<div className=" w-full">
									<select
										onChange={(e) => setProjectSub(e.target.value)}
										className="form-select appearance-none  w-full px-3  py-2  bg-bgclr bg-clip-padding bg-no-repeat rounded transition ease-in-out  m-0 outline-none"
										aria-label="projectsub"
										required
									>
					...
					<div className="flex flex-col lg:flex-row items-center gap-5">
						<div className="mb-3 flex flex-col items-start w-full">
							...
							<input
								className="form-control  block w-full px-3  rounded py-2 text-base  font-normal bg-clip-padding bg-bgclr
                      outline-none focus:outline-none"
						...
						<div className="mb-3 flex flex-col items-start w-full">
							...
							<input
								...
								className="w-full bg-bgclr rounded py-2 px-3 outline-none"
								id="Client-Name"
								onChange={(e) => setClient_origin(e.target.value)}
					...
					<div className="mb-3 flex flex-col items-start w-full">
						<label for="projectShortDesc" className="font-bold mb-1">
							Short Description *
						</label>
						<textarea
							className="w-full bg-bgclr rounded py-1 px-3 outline-none"
							id="projectShortDesc"
							rows="4"
					...
					<div className="mb-3 flex flex-col items-start w-full">
						<label for="projectDesc" className="font-bold mb-1">
							Description *{" "}
						</label>
						<textarea
							className="w-full bg-bgclr rounded py-1 px-3 outline-none"
