...
function Pagination({ gotoPage, length, pageSize, setPageSize }) {
    ...
    return (
        <div className="flex flex-col lg:flex-row  items-center justify-center lg:justify-between mt-3">
            <span>Show
                <select
                    className="px-2 py-[6px] border rounded-md w-30 bg-white mx-2"
                    value={pageSize}
            ...
            <div className="m-4 flex items-center justify-center">
                <button
                    ...
                    className="m-1 px-2 py-1 border rounded-md hover:bg-blue hover:text-white"
                >
                    <p>Previous</p>
                </button>
                {pages.map((page, i) => (
                    <button
                        ...
                        className={`m-1 px-3 py-1 border rounded-md ${currentPage === page ? "bg-blue text-white" : "bg-white text-blue"} hover:bg-blue hover:text-white`}
                    >
                        {page}
                    </button>
                ))}
